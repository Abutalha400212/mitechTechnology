...
const Blog = () => {
    return (
        <div className='blog'>
            <div>
                <h3>Question no-1: what is cors?</h3>
            ...
            <div>
                <h3>Question no-2:Why are you using firebase? What other options do you have to implement authentication?</h3>
                <p><small>
            ...
            <div>
                <h3>Question no-3: How does the private route work?</h3>
            ...
            <div>
                <h3>Question no-4: What is Node? How does Node work?</h3>
